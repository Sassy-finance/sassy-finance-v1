...
export interface GroupVotingSetupInterface extends utils.Interface {
  functions: {
...
export interface GroupVotingSetup extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GroupVotingSetupInterface;
