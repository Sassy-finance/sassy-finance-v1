...
export interface GroupVotingInterface extends utils.Interface {
  functions: {
    "CREATE_GROUP_PERMISSION_ID()": FunctionFragment;
    ...
    "createGroup(string,address[],address,uint256)": FunctionFragment;
    "createProposal(bytes,(address,uint256,bytes)[],uint256,uint64,uint64,uint8,bool,uint256)": FunctionFragment;
    "createProposal(bytes,(address,uint256,bytes)[],uint256,uint64,uint64,uint8,bool)": FunctionFragment;
    "dao()": FunctionFragment;
    "execute(uint256)": FunctionFragment;
    "getGroupVault(uint256)": FunctionFragment;
    "getProposal(uint256)": FunctionFragment;
    "getVoteOption(uint256,address)": FunctionFragment;
    "groupVault(uint256)": FunctionFragment;
    "groups(uint256)": FunctionFragment;
    "groupsNames(string)": FunctionFragment;
    "implementation()": FunctionFragment;
    "initialize(address,(uint8,uint32,uint32,uint64,uint256))": FunctionFragment;
    "isListedAtBlock(address,uint256,uint256)": FunctionFragment;
    "isMember(address,uint256)": FunctionFragment;
    ...
    "proposalGroup(uint256)": FunctionFragment;
    "proxiableUUID()": FunctionFragment;
    "removeAddresses(address[],uint256)": FunctionFragment;
    ...
    "withdrawERC20(address,uint256,address,uint256)": FunctionFragment;
    "withdrawNFT(address,uint256,address,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "CREATE_GROUP_PERMISSION_ID",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "createProposal(bytes,(address,uint256,bytes)[],uint256,uint64,uint64,uint8,bool,uint256)",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "createProposal(bytes,(address,uint256,bytes)[],uint256,uint64,uint64,uint8,bool)",
    values: [
      PromiseOrValue<BytesLike>,
      IDAO.ActionStruct[],
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "getGroupVault",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<string>, MajorityVotingBase.VotingSettingsStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isMember(address,uint256)",
    values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "isMember(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "proposalGroup",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "totalVotingPower(uint256)",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "totalVotingPower(uint256,uint256)",
  ...
  decodeFunctionResult(functionFragment: "groupVault", data: BytesLike): Result;
...
export interface GroupVoting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GroupVotingInterface;
  ...
  functions: {
    CREATE_GROUP_PERMISSION_ID(overrides?: CallOverrides): Promise<[string]>;
    ...
    createGroup(
      ...
      _members: PromiseOrValue<string>[],
      _tokenAllocation: PromiseOrValue<string>,
      _initialAllocation: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  estimateGas: {
    CREATE_GROUP_PERMISSION_ID(overrides?: CallOverrides): Promise<BigNumber>;
