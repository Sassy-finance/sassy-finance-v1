...
import type {
  MajorityVotingBase,
  MajorityVotingBaseInterface,
} from "../../../../../../@aragon/osx/plugins/governance/majority-voting/MajorityVotingBase";
...
export class MajorityVotingBase__factory {
  static readonly abi = _abi;
  static createInterface(): MajorityVotingBaseInterface {
    return new utils.Interface(_abi) as MajorityVotingBaseInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): MajorityVotingBase {
    return new Contract(address, _abi, signerOrProvider) as MajorityVotingBase;
  }
}
