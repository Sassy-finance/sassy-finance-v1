...
export interface AddresslistVotingSetupInterface extends utils.Interface {
  functions: {
...
export interface AddresslistVotingSetup extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AddresslistVotingSetupInterface;
